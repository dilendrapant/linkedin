...
public class PeopleDAOImpl implements PeopleDAO {
	...
	public People get(int id) {
		return sessionFactory.getCurrentSession().get(People.class, Integer.valueOf(id));
	}
	...
	//
	// WebElement name =
	// driver.findElement(By.cssSelector(".pv-top-card-section__name"));
	// String[] arr =
	// driver.findElement(By.cssSelector("body")).getText().split("\n");
	// String regex = "^[0-9]+.*";
	//
	// int i = 0;
	// int j = 0;
	...
	// pd.fetchData("https://www.linkedin.com/in/dilendra");
	// }
